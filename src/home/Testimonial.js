          ...
          <div className="flex flex-wrap -m-4">
            <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
              <div className="h-full text-center transition-transform transform hover:scale-105 shadow-lg hover:shadow-xl p-6 bg-white rounded-lg">
                ...
                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">SOPHIA TURNER</h2>
            ...
            <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
              <div className="h-full text-center transition-transform transform hover:scale-105 shadow-lg hover:shadow-xl p-6 bg-white rounded-lg">
                ...
                <span className="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">LIAM JAMES</h2>
            ...
            <div className="lg:w-1/3 lg:mb-0 p-4">
              <div className="h-full text-center transition-transform transform hover:scale-105 shadow-lg hover:shadow-xl p-6 bg-white rounded-lg">
                ...
                <span className="inline-block h-1 w-10 rounded bg-indigo-500 mt-6 mb-4"></span>
                <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">EMMA WATSON</h2>
